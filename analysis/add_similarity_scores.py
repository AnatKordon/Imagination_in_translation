...
CSV_PATH = config.PROCESSED_DIR /"ppt_trials_w_similarity_trials_with_gen.csv" # should use corrected gt if nesseceary, this is the original good file with participant data: "participants_log_with_gpt_pilot_08092025.csv"  # Path to my CSV for analysis
OUTPUT_CSV = config.PROCESSED_DIR / "ppt_trials_w_similarity_trials_with_gen_updated.csv"  # Path to save the output CSV with similarity scores
